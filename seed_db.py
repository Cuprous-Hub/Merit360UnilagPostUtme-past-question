...
def seed_english():
    ...
    lexis_items = [
        ("The boy was punished because he ___ his teacher's instructions.", "ignored", "disobeyed", "violated", "omitted", "B", "'Disobey' specifically means to fail to follow instructions from an authority figure."),
        ("Hardly had she finished speaking ___ the bell rang.", "when", "than", "then", "but", "A", "'Hardly...when' is the correct correlative pair showing immediate sequence."),
        ("The workers have complained that their salaries are not ___ with the work they do.", "consistent", "compatible", "commensurate", "convenient", "C", "'Commensurate with' means proportionate to or matching in measure."),
        ("The teacher encouraged the students to look ___ new words in the dictionary.", "into", "up", "out", "over", "B", "'Look up' is the correct phrasal verb meaning to search for information in a reference."),
        ("He has a good command ___ the English language.", "for", "on", "over", "of", "D", "'Command of' is the fixed prepositional phrase meaning mastery or control."),
        ("We were advised to abstain ___ bad habits.", "of", "from", "off", "with", "B", "'Abstain from' is the correct collocation meaning to deliberately avoid something."),
        ("My uncle, together with his children, ___ arriving today.", "are", "were", "is", "have been", "C", "'Together with' does not change the subject; 'my uncle' is singular, so use 'is'."),
        ("He is the man ___ broke the window.", "whom", "whose", "which", "who", "D", "'Who' is used as a subject relative pronoun referring to a person performing an action."),
        ("If I ___ you, I would accept the offer.", "were", "was", "am", "be", "A", "Subjunctive mood requires 'were' for all persons in unreal conditional sentences."),
        ("Not only does she sing, but she ___ plays the piano.", "also", "too", "either", "as well", "A", "'Not only...but also' is the correct correlative conjunction pair."),
        ("The thief was caught because someone had given him ___.", "out", "away", "off", "in", "B", "'Give away' means to reveal a secret or betray someone's identity."),
        ("The committee will meet to ___ the issue.", "dissolve", "discard", "deliberate", "disseminate", "C", "'Deliberate on' means to carefully consider and discuss a matter formally."),
        ("I am not used to ___ early.", "waking", "wake", "woken", "woke", "A", "After 'used to' (habit), the gerund (-ing form) must follow the preposition 'to'."),
        ("He prefers tea ___ coffee.", "than", "than to", "to", "over", "C", "'Prefer...to' is the correct construction when comparing two things."),
        ("The teacher asked the students to be quiet, but ___ listened.", "neither", "none", "nobody", "few", "D", "'Few' refers to a small number in a group and fits grammatically with the plural verb."),
        ("We were warned ___ the dangers of reckless driving.", "about", "on", "with", "for", "A", "'Warned about' is the correct collocation for alerting someone to a danger."),
        ("She looked forward to ___ her friend.", "see", "seeing", "seen", "saw", "B", "After 'look forward to', a gerund (-ing) must follow the preposition 'to'."),
        ("I don't mind ___ for a few minutes.", "to wait", "wait", "waiting", "waited", "C", "After 'mind', the gerund form (-ing) is required, not the infinitive."),
        ("The man is not only rich ___ generous.", "also", "and", "but also", "or", "C", "'Not only...but also' is the standard correlative conjunction pairing."),
        ("The manager said he would look ___ the matter.", "up", "into", "off", "after", "B", "'Look into' means to investigate or examine a matter more closely."),
        ("His parents objected ___ his plans.", "to", "with", "at", "on", "A", "'Object to' is the fixed prepositional phrase expressing disapproval."),
        ("The girl was accused ___ stealing the book.", "for", "of", "about", "on", "B", "'Accused of' is the correct collocation in formal and legal English."),
        ("The driver was penalized ___ speeding.", "of", "for", "with", "on", "B", "'Penalized for' is the correct prepositional phrase expressing the reason for punishment."),
        ("He was so tired that he ___ asleep during the lecture.", "falls", "fell", "fallen", "falling", "B", "Simple past 'fell' is required to match the past tense narrative context."),
        ("The principal insisted that the student ___ suspended.", "be", "is", "was", "has been", "A", "After verbs of insistence, the subjunctive base form 'be' is required."),
        ("The boy asked me if I ___ him a pen.", "can borrow", "could lend", "can lend", "could borrow", "B", "In reported speech past context, 'lend' (give) fits the meaning; 'could' is the past modal."),
        ("The culprit confessed ___ the crime.", "to committing", "to commit", "committing", "having commit", "A", "'Confess to' requires the preposition 'to' followed by a gerund."),
        ("The man was accused of ___ his position.", "abusing", "insulting", "abasing", "misusing", "A", "'Abuse a position' means to use it improperly for personal gain."),
        ("The lady looks ___ in her new dress.", "beautiful", "beautifully", "beauty", "beauteous", "A", "After a linking verb like 'looks', an adjective (not adverb) is required."),
        ("We were advised to work hard ___ we fail.", "in order that", "unless", "so that", "lest", "D", "'Lest' expresses a negative purpose and is followed by 'should' or the subjunctive."),
        ("I told them to go home, ___?", "didn't I", "don't I", "hadn't I", "haven't I", "A", "The tag question for simple past 'told' is 'didn't I'."),
        ("They are not used to ___ this kind of hardship.", "face", "facing", "faced", "be facing", "B", "After 'used to' as a habit phrase, the gerund (-ing) follows the preposition 'to'."),
        ("Many people are allergic ___ dust.", "from", "of", "to", "with", "C", "'Allergic to' is the fixed prepositional collocation for this adjective."),
        ("The movie is interesting, ___?", "is it", "isn't it", "was it", "wasn't it", "B", "Tag questions for affirmative present tense use a negative auxiliary: 'isn't it'."),
        ("He came late to school ___ the heavy rain.", "due to", "because", "although", "even though", "A", "'Due to' introduces a noun phrase as the cause; 'because' requires a clause."),
        ("The ___ of the meeting was to discuss the school fees.", "purpose", "propose", "proposal", "proposement", "A", "'Purpose' is the correct noun meaning aim or intention; 'proposement' is not a word."),
        ("Neither the teacher nor the students ___ present.", "is", "are", "was", "were", "B", "With 'neither...nor', the verb agrees with the nearer subject 'students' (plural)."),
        ("He is not ___ to go to the party.", "enough tall", "tall enough", "taller enough", "enough taller", "B", "In English, 'enough' follows the adjective: adjective + enough."),
        ("If he had studied harder, he ___ passed.", "will have", "would have", "would", "will", "B", "Third conditional (unreal past) requires 'would have + past participle'."),
        ("That bag is hers, isn't ___?", "she", "it", "he", "her", "B", "The pronoun in the tag question refers to 'that bag' which is 'it'."),
    ]
    for q in lexis_items:
        all_english.append({'text': q[0], 'a': q[1], 'b': q[2], 'c': q[3], 'd': q[4], 'ans': q[5], 'exp': q[6], 'topic': lexis.id})
    ...
    grammar_explanations = [
        "With 'as well as', the verb agrees with the first subject 'the girl' (singular).",
        "Third conditional: 'had known' + 'would have told' for unreal past.",
        "'Together with' is a parenthetical phrase; verb agrees with 'the teacher' (singular).",
        "With 'neither...nor', verb agrees with the nearer subject 'sister' (singular).",
        "After 'used to' as a present habit phrase, a gerund follows the preposition 'to'.",
        "Past perfect 'had finished' shows action completed before another past event.",
        "'Each' is singular and always takes a singular verb.",
        "'Hardly...when' is the correct correlative pair for immediate past sequence.",
        "'Would rather' is followed by past tense for preference about another person.",
        "Third conditional inversion: 'had they arrived' for unreal past condition.",
        "'As though' introduces an unreal comparison, requiring the subjunctive 'were'.",
        "After verbs of insistence/demand, the subjunctive base form 'be' is used.",
        "'Scarcely...when' is the correct correlative pair, not 'than'.",
        "Present perfect is used with 'since' to show duration from a past point.",
        "'It's high time' requires the past subjunctive to express urgency.",
        "Simple past is used in the main clause of third conditional sentences.",
        "Simple past is correct in a simple past narrative context.",
        "After verbs of demand like 'insist', the subjunctive 'increase' (base form) is used.",
        "Third conditional requires 'would have + past participle' in the main clause.",
        "With 'accompanied by', the verb agrees with the main subject 'Vice Chancellor' (singular).",
        "'Not only...but also' requires parallel structure; 'contradictory' is the parallel adjective.",
        "'Before' introduces a time clause showing prior action.",
        "'Spellbound' means completely captivated, fitting the context of compelling film.",
        "'Flaunt' means to display ostentatiously; 'flout' means to disobey.",
        "'Phase out' means to gradually eliminate or withdraw something.",
        "'Compromise' means a mutual agreement where both sides give something up.",
        "'Vehement' means showing strong feeling; best describes passionate opposition.",
        "'Flaws' means defects or errors in reasoning.",
        "'Coup' (d'état) means a sudden seizure of power from a government.",
        "'So...that' is the correct result clause construction.",
    ]
    for q, exp in zip(grammar_items, grammar_explanations):
        all_english.append({'text': q[0], 'a': q[1], 'b': q[2], 'c': q[3], 'd': q[4], 'ans': q[5], 'exp': exp, 'topic': grammar.id})
    ...
    advanced_explanations = [
        "Inverted conditional 'Were he...' requires 'wouldn't have' in the result clause.",
        "'As though' + past perfect 'had been' expresses an unreal past comparison.",
        "'Scarcely...when' is the correct correlative pair for immediate past sequence.",
        "'No sooner...than' is the fixed correlative pair, not 'when'.",
        "Third conditional 'if only' requires past perfect 'had left' for unreal past.",
        "After 'imperative that', the subjunctive base form 'meet' is required.",
        "'As if' + past perfect 'had happened' for unreal past comparison.",
        "After verbs of command/demand, the subjunctive base form 'be' is used.",
        "With 'neither...nor', verb agrees with the nearer subject 'assistants' (plural).",
        "Third conditional: 'had taken' in the if-clause, 'would not have failed' in result.",
        "'Condemnable' (deserving condemnation) is parallel to 'unacceptable' as an adjective.",
        "'Cogent' means convincing and well-reasoned, fitting a winning debate argument.",
        "'Benevolent' means well-meaning and generous, the positive treatment descriptor.",
        "Third conditional inversion 'had the doctor arrived' + 'might have survived'.",
        "'Vehemence' means forcefulness of expression, appropriate for a convincing lawyer.",
        "Third conditional 'I wish' requires past perfect 'had taken' for past regret.",
        "Inverted conditional 'Had he known' + 'wouldn't have made' for unreal past.",
        "After 'insist that', the subjunctive base form 'increase' is required.",
        "'Would have' is required in the main clause of a third conditional.",
        "'Accompanied by' is parenthetical; verb agrees with 'Vice Chancellor' (singular).",
        "'Contradictory' (self-opposing) is parallel to 'unconvincing' as a negative adjective.",
        "'Before' introduces a subordinate time clause before the main action.",
        "'Spellbound' means completely fascinated and unable to look away.",
        "'Flaunt' means to display ostentatiously; 'flout' means to disregard rules.",
        "'Phase out' means to gradually eliminate over time.",
        "'Compromise' is a settlement where both parties make concessions.",
        "'Vehement' means passionate and intense, describing fierce opposition.",
        "'Flaws' are defects or errors; it correctly completes 'logical flaws'.",
        "'Coup' (d'état) is the seizure of power, often by the military.",
        "'So...that' introduces a result clause showing the consequence of the manner.",
    ]
    for q, exp in zip(advanced_items, advanced_explanations):
        all_english.append({'text': q[0], 'a': q[1], 'b': q[2], 'c': q[3], 'd': q[4], 'ans': q[5], 'exp': exp, 'topic': adv_grammar.id})
    ...
    oral_explanations = [
        "'sit' contains the short vowel /ɪ/, while seat, beat, and neat all have the long /iː/ sound.",
        "'foot' has the short /ʊ/ vowel sound, unlike boot, root, and loot which all have /uː/.",
        "'chef' starts with /ʃ/ (sh-sound), while chew, chain, and chart all start with /tʃ/.",
        "'cut' contains the /ʌ/ vowel; 'full' has /ʊ/, and 'pool'/'cool' have /uː/.",
        "'this' uses the voiced /ð/ sound; thing, thought, and think all use voiceless /θ/.",
        "'genre' starts with /ʒ/ (French-origin sound); judge, jungle, ginger start with /dʒ/.",
        "'pain' contains the diphthong /eɪ/; cat has /æ/, said has /ɛ/, bed has /e/.",
        "'bat' shares the /æ/ vowel with 'hat'; car and heart have /ɑː/, cup has /ʌ/.",
        "'bag' ends with the plosive /g/; fan is fricative /f/, ship is fricative /ʃ/, zoo is fricative /z/.",
        "The word 'judge' ends with the voiced affricate /dʒ/, not a plosive or fricative.",
        "'sort' has the long /ɔː/ vowel; hot has /ɒ/, hut has /ʌ/, cat has /æ/.",
        "'mission' contains /ʃ/; pleasure and vision have /ʒ/, genre has /ʒ/ (French origin).",
        "'ph' in English is always pronounced /f/, not /p/; this is a fixed spelling rule.",
        "'boat' contains the diphthong /əʊ/; caught has /ɔː/, bet has /e/, box has /ɒ/.",
        "'sure' begins with the /ʃ/ sound, not /s/; a common pronunciation exception in English.",
        "In 'education' (ed-u-CA-tion), the primary stress falls on the third syllable '-ca-'.",
        "As a verb, 'conTRACT' stresses the second syllable; nouns like CONtract stress the first.",
        "In 'PHO-to-graph', the stress is on the first syllable; it shifts in 'pho-TOG-ra-phy'.",
        "WH-questions (who, what, where) typically use falling intonation in English.",
        "Yes/no questions like 'Are you coming?' typically end with rising intonation.",
        "'REcord' as a noun stresses the first syllable; as a verb 'reCORD' stresses the second.",
        "In 'pre-sen-TA-tion', the primary stress falls on the third syllable '-ta-'.",
        "Rising intonation signals the question is not yet complete and expects a yes/no answer.",
        "In 'un-der-STAND', the primary stress is on the final syllable '-stand'.",
        "In 'e-CON-o-my', the stress falls on the second syllable '-con-'.",
        "Commands like 'Come in' use falling intonation because they are definitive statements.",
        "In 'de-MO-cra-cy', the stress falls on the second syllable '-mo-'.",
        "In a list, intonation rises on each item to show continuation, then falls on the last item.",
        "Content words (nouns, verbs, adjectives) carry the most communicative weight and are stressed.",
        "Offers and polite questions like 'Can I help you?' use rising intonation to invite response.",
    ]
    for q, exp in zip(oral_items, oral_explanations):
        all_english.append({'text': q[0], 'a': q[1], 'b': q[2], 'c': q[3], 'd': q[4], 'ans': q[5], 'exp': exp, 'topic': oral.id})
